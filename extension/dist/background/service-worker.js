...
import { appendEvent, loadEvents, loadSettings, replaceEvents, saveSettings } from './storage.js';
import { requestAnalysis } from './analysis.js';
import { demoEvent, DEMO_TOTAL } from './demo.js';
import { shouldRecord } from '../content/reading-session.js';
import { CONFIG, FLAGS } from '../shared/config.js';
import { buildAggregates, MIN_SAMPLES } from '../core/aggregate.js';
import { localId, ANALYSIS_VERSION } from '../core/model.js';
 ...
 */
async function reapStalePlaceholders()                {
