...
export class ReadingSession {
  ...
  constructor(hooks              , thresholdSeconds = CONFIG.MIN_VISIBLE_SECONDS) {
    this.#hooks = hooks;
    this.#thresholdMs = thresholdSeconds * 1000;
  }

  get visibleMs()         { return this.#visibleMs; }
  get fired()          { return this.#fired; }
  get key()         { return this.#key; }
  /** 达到阈值但尚未触发时，页面关闭前应当补记 */
  get qualifiesNow()          { return !this.#fired && this.#visibleMs >= this.#thresholdMs; }
