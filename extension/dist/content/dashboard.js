...
import { computeLayout, explainLayout, measure, measurementChanged, staysOutOfContent, FULL_WIDTH, MARGIN, MIN_TOP } from './layout.js';
import { locateContentElement } from './extract-content.js';
...
export class Dashboard {
  ...
  #cb                    ;
  #lastView                   = null;
  #layout              = { mode: 'full', left: MARGIN, top: MIN_TOP, width: FULL_WIDTH };
  ...
  #collapsed(view           , score               , preliminary = false)         {
    const label =
  ...
  // ── 展开态 ────────────────────────────────────────────────
  #expanded(view           , score               , preliminary = false)         {
    return `
      <div class="row head">
  ...
  #body(view           , score               , preliminary = false)         {
    switch (view.state) {
      case 'empty':
