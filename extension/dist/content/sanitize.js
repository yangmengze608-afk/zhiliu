...
export function textWithoutNoise(el         )         {
 ...
 */
export function sanitize(raw        , title = '')         {
  const lines = raw
    .split(/\n+/)
 ...
 */
export function truncateForModel(text        , limit = MAX_MODEL_CHARS)                   {
